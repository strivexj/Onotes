...
public class SettingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        if(language.equals("en")){
            ...
            //ToastUtil.showToast(Locale.getDefault().toString(), Toast.LENGTH_LONG);
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.logout:
                ...
                break;
            case R.id.chinese:
               // if (english.isChecked()||traditional_chinese.isChecked()) {
                    //english.setChecked(false);
                   // traditional_chinese.setChecked(false);
              //  }
